...
def traveling_salesman_spatial_bb_conic(conic_graph, tol, gurobi_parameters=None):
...
def traveling_salesman_spatial_bb(convex_graph, tol=1e-4, gurobi_parameters=None):
        conic_graph = convex_graph.to_conic()
        traveling_salesman_spatial_bb_conic(conic_graph, tol, gurobi_parameters)
