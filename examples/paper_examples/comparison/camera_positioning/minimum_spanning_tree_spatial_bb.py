...
def minimum_spanning_tree_spatial_bb_conic(conic_graph, conic_root, tol, gurobi_parameters=None):
    ...
    for i, vertex in enumerate(conic_graph.vertices):
        ...
        for k in conic_graph.incoming_edge_indices(vertex):
...
def minimum_spanning_tree_spatial_bb(convex_graph, root=None, tol=1e-4, gurobi_parameters=None):
    """
    ...
    minimum_spanning_tree_spatial_bb_conic(conic_graph, conic_root, tol, gurobi_parameters)
